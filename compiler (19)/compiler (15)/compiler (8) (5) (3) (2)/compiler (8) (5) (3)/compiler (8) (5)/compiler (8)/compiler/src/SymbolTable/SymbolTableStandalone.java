...
public class SymbolTableStandalone {
    private final Map<String, Symbol> symbols = new HashMap<>();
    private static final SymbolTableStandalone instance = new SymbolTableStandalone();

    private SymbolTableStandalone() {}

    public static SymbolTableStandalone getInstance() {
        return instance;
    }
