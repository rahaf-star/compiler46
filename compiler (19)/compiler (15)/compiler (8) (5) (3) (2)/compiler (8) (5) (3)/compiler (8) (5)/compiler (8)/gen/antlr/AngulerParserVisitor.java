...
public interface AngulerParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link AngulerParser#primary}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPrimary(AngulerParser.PrimaryContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code conditional_statementsIns}
	 * labeled alternative in {@link AngulerParser#instruction}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitConditional_statementsIns(AngulerParser.Conditional_statementsInsContext ctx);
	/**
	 * Visit a parse tree produced by {@link AngulerParser#conditional_statements}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitConditional_statements(AngulerParser.Conditional_statementsContext ctx);
	/**
