...
public interface AngulerParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link AngulerParser#primary}.
	 * @param ctx the parse tree
	 */
	void enterPrimary(AngulerParser.PrimaryContext ctx);
	/**
	 * Exit a parse tree produced by {@link AngulerParser#primary}.
	 * @param ctx the parse tree
	 */
	void exitPrimary(AngulerParser.PrimaryContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by the {@code conditional_statementsIns}
	 * labeled alternative in {@link AngulerParser#instruction}.
	 * @param ctx the parse tree
	 */
	void enterConditional_statementsIns(AngulerParser.Conditional_statementsInsContext ctx);
	/**
	 * Exit a parse tree produced by the {@code conditional_statementsIns}
	 * labeled alternative in {@link AngulerParser#instruction}.
	 * @param ctx the parse tree
	 */
	void exitConditional_statementsIns(AngulerParser.Conditional_statementsInsContext ctx);
	/**
	 * Enter a parse tree produced by {@link AngulerParser#conditional_statements}.
	 * @param ctx the parse tree
	 */
	void enterConditional_statements(AngulerParser.Conditional_statementsContext ctx);
	/**
	 * Exit a parse tree produced by {@link AngulerParser#conditional_statements}.
	 * @param ctx the parse tree
	 */
	void exitConditional_statements(AngulerParser.Conditional_statementsContext ctx);
	/**
