...
function showPage(page) {
    ...
    navLinks.forEach(link => {
        if (link.textContent === (page === 'display' ? 'عرض المنتجات' : 'إضافة منتج')) {
    ...
    if (page === 'display') {
        currentPageElement.textContent = 'عرض المنتجات';
        // إظهار قائمة المنتجات وإخفاء نموذج الإضافة
        document.querySelector('.product-list').style.display = 'grid';
        document.querySelector('.modal .container .add-form').style.display = 'none';
        document.querySelector('.add-button').style.display = 'block';
        document.querySelector('.modal > .add-form').style.display = 'none';
    } else {
        currentPageElement.textContent = 'إضافة منتج';
        // إخفاء قائمة المنتجات وإظهار نموذج الإضافة
